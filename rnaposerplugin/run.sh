...
then
    ...
    echo "example: $0 test/complex.pdb test/lig.mol2 test/complexes.dcd 2.5 248 test/feature test/score.txt"
else
    pdb=$1
    mol2=$2
    dcd="$3"
    ...
    # get score
    python ../src/rna_poser.py --classifier ../classifier/eta${eta}/RF_${rmsd}.predictor.pkl  --features ${feature_file}_traj1.txt --output ${class_score_file}
