...
then
    ...
    python -W ignore $RNAPOSERS_PATH/py/inference.py --classifier $RNAPOSERS_PATH/classifier/eta${eta}/RF_${rmsd}.predictor.pkl  --features ${feature_file}_traj1.txt --output ${class_score_file} > /dev/null
